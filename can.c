...
static bool fdu_s11n_read_can_bin_(fdu_can_frame_t* value,
...
static bool fdu_s11n_write_can_bin_(const fdu_can_frame_t* value,
...
bool fdu_s11n_read_can_bin(fdu_can_frame_t* value,
                           const unsigned char** startp,
                           const unsigned char* end)
{
...
bool fdu_s11n_write_can_bin(const fdu_can_frame_t* value,
                            unsigned char** startp,
                            const unsigned char* end)
{
    const fdu_endianness_t old_endianness = fdu_s11n_get_endianness();
...
static void write_nibble(unsigned char** startp,
                         unsigned char byte)
{
...
static int calc_byte_size(const bool extended,
                          const unsigned char can_data_size,
                          const bool write_null)
{
